...
public class Tickets extends BaseEntity {
	...
	public Tickets(Users userId, Shedules sheduleId, CabinTypes cabinTypeId, String firstName, String lastName,
			String email, String phone, String passport_number, Countries passportCountryId, Long passportPhoto,
			String booking_reference, Boolean confirmed) {
		super();
		this.userId = userId;
